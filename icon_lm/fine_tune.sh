...
python3 run.py --problem 'icon_lm' \
  --epochs 20 \
  --train_batch_size 24 \
  --train_data_dirs '/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/data/pde_linear_3d' \
  ...
  --model icon_lm \
  --restore_dir /work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/jamie/ckpts/icon_lm/20240716-143836 \
  --restore_step 900000 \
  --loss_mode nocap \
  --user 'fine_tune' \
  --nodeterministic \
