...
CUDA_VISIBLE_DEVICES=0 python3 run.py --problem 'icon' --epochs 100 \
  --train_batch_size 32 --train_data_dirs '/work2/09989/jmahowald/frontera/in-context-operator-networks/icon-lm/data' \
...
python3 run.py --problem 'icon_gpt2' --epochs 100 \
  --train_batch_size 10 --train_data_dirs '/work2/09989/jmahowald/frontera/in-context-operator-networks/icon-lm/data' \
