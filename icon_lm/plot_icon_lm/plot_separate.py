...
def plot_hero_sep():
  ...
  draw_seperate(folder = "/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/{}-nocap".format(stamp),   demo_num_list = [0,1,2,3,4,5], caption_id = -1, title = 'no caption')
  draw_seperate(folder = "/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/{}-vague".format(stamp),   demo_num_list = [0,1,2,3,4,5], caption_id = 0, title = 'vague caption')
  draw_seperate(folder = "/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/{}-precise".format(stamp), demo_num_list = [0,1,2,3,4,5], caption_id = 0, title = 'precise caption')
