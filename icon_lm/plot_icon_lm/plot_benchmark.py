'Plot the benchmark of ICON-LM with baseline, small models'
import pickle
import numpy as np
...
def draw_join(demo_num_list, style_dict, folder_dict, title = None, plot = plt.plot, figsize=(4,3), ylim = (None, None)):
	'draw the join plot for the error of different models'
	all_error = {}
...
def plot_benchmark():
	...
	folder_dict = {
								'ICON-LM (ours)': ["/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/icon_lm_learn_s1-20231005-094726",
																	"/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/icon_lm_learn_s2-20231008-110255",
																	"/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/icon_lm_learn_s3-20231009-173624"],
								'Encoder-Decoder ICON': ["/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/v1baseline_s1-20231004-103259",
																				 "/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/v1baseline_s2-20231006-114142",
																				 "/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/v1baseline_s3-20231007-175037"]
								}
