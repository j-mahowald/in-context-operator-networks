...
def plot_hero_join_cap_vs_nocap():
  ...
  folder_dict = {
                  'no caption': ["/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/{}-testdata-testcap-{}".format(stamp, 'nocap')],
                  'value caption': ["/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/{}-testdata-testcap-{}".format(stamp, 'vague')],
                  'precise caption': ["/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/{}-testdata-testcap-{}".format(stamp, 'precise')],
                }
