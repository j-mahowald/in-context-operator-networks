...
CUDA_VISIBLE_DEVICES=0 python3 run.py --problem 'icon' --epochs 100 \
  --train_batch_size 32 --train_data_dirs '/workspace/Jamie/in-context-operator-networks/icon-lm/data/data0910c' \
...
CUDA_VISIBLE_DEVICES=0 python3 run.py --problem 'icon_lm' --epochs 100 \
  --train_batch_size 24 --train_data_dirs '/workspace/Jamie/in-context-operator-networks/icon-lm/data/data0910c' \
...
python3 run.py --problem 'icon_gpt2' --epochs 100 \
  --train_batch_size 10 --train_data_dirs '/workspace/Jamie/in-context-operator-networks/icon-lm/data/data0910c' \
