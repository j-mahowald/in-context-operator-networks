...
def run_train():
  ...
  if FLAGS.tfboard:
    results_dir = f'/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/{FLAGS.user}/results/{FLAGS.problem}/'+ stamp
    file_writer = tf.summary.create_file_writer(results_dir)
    file_writer.set_as_default()
    ckpt_dir = f'/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/{FLAGS.user}/ckpts/{FLAGS.problem}/'+ stamp
