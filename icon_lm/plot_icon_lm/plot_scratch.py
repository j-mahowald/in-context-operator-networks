...
def plot_train_vs_test():
  ...
  folder_dict = {
                  'pretrained GPT-2, training captions': ["/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/icon_gpt2_full_s1-{}-testdata-traincap-{}".format(pretrained_stamp, cap)],
                  'pretrained GPT-2, testing captions': ["/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/icon_gpt2_full_s1-{}-testdata-testcap-{}".format(pretrained_stamp, cap)],
                  'unpretrained GPT-2, training captions': ["/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/icon_gpt2_unpretrained-s1-{}-testdata-traincap-{}".format(unpretrained_stamp, cap)],
                  'unpretrained GPT-2, testing captions': ["/work2/09989/jmahowald/frontera/in-context-operator-networks/icon_lm/analysis/icon_gpt2_unpretrained-s1-{}-testdata-testcap-{}".format(unpretrained_stamp, cap)],
                  }
